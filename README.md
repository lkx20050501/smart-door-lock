...
| 硬件实物 | 手机 App |
|---|---|
| ![硬件实物](docs/hardware.jpg) | ![App 主页](docs/app_home.jpg) |
...
├── README.md
├── firmware/
│   └── k230_smart_door_with_env.py     K230 主程序
├── app/
│   └── lib/
...
3. 用 CanMV IDE 运行 `firmware/k230_smart_door_with_env.py`，串口会打印设备 IP。

**Flutter App**
1. 用 Android Studio / VS Code 打开 `app/`，`flutter pub get` 安装依赖。
